...
import { getAll } from '@/actions/sistema/modulos_opcoes'
...
export default function Grid() {
    ...
    // const [dados, setDados] = useState<modulosType[]>([])
    ...
    const urlBase = '/admin/sistema/modulos_opcoes'
    ...
    const botoesDataTable = (dados: modulosType) => {
        return (
            <>
    ...
    const formataTemAtendentes = (dados: modulosType) => {
        return (
            <>
                {dados.temAtendentes == 'S' ? 'Sim' : 'Não'}
            </>
        )
    }

    const formataRealizaVendas = (dados: modulosType) => {
        return (
            <>
                {dados.realizaVendas == 'S' ? 'Sim' : 'Não'}
            </>
        )
    }
    ...
    return (
        ...
        <div className='mx-3'>
            ...
            <PageSubTitle texto="Cadastro de Módulos e Opções" />
            ...
            <div className="mt-2">
                ...
                <div className="hidden md:block" >
                    <DataTable value={dados} size="small" stripedRows showGridlines selectionMode="single" >
                        <Column field="id" header="ID" sortable></Column>
                        <Column field="nome" header="Nome" sortable></Column>
                        <Column body={formataRealizaVendas} header="Realiza Vendas" sortable></Column>
                        <Column body={formataTemAtendentes} header="Tem Atendentes" sortable></Column>
                        <Column body={formataStatus} header="Status" sortable></Column>
                        <Column body={botoesDataTable} exportable={false}></Column>
                    </DataTable>
                </div>
