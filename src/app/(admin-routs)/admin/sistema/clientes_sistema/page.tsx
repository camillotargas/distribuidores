...
import { getAll } from '@/actions/sistema/clientes_sistema'
...
export default function Grid() {
    ...
    const urlBase = '/admin/sistema/clientes_sistema'
    ...
    const botoesDataTable = (dados: clientesSistemaType) => {
        return (
            <>
    ...
    const formataDataFimLicenca = (dados: clientesSistemaType) => {
        return (
            <>
                {uData.formataData(dados.dataFimLicenca)}
            </>
        )
    }

    const formataCnpj = (dados: clientesSistemaType) => {
        return (
            <>
    ...
    const formataStatus = (dados: clientesSistemaType) => {
        return (
            <>
            ...
            <div className="mt-2">
                ...
                <div className="md:hidden">
                    <DataTable value={dados} size="small" stripedRows showGridlines selectionMode="single" >
                        ...
                        <Column body={formataDataFimLicenca} header="Fim Licença" sortable></Column>
