...
import { clientesSistemaType, clientesSistemaSchema } from '@/types/sistema/clientes_sistema'
import { codigoNomeType } from '@/types/sistema/codigoNome'
import { postPut, getById } from '@/actions/sistema/clientes_sistema'
...
export default function Formulario() {
    ...
    const [dados, setDados] = useState<clientesSistemaType>({} as clientesSistemaType)
    ...
    const { control, handleSubmit, formState: { errors }, setValue, getValues, trigger } = useForm<clientesSistemaType>({
        defaultValues: dados,
        values: dados,
        resolver: zodResolver(clientesSistemaSchema)
    })
    ...
    async function buscaDados() {
        ...
        if (retorno.erro !== '') {
            ...
            setDados({} as clientesSistemaType)
        } else {
            messages.current?.clear()
            setDados(retorno.dados as clientesSistemaType)
            setIsLoading(false)
        }
    ...
    async function onSubmit(dados: clientesSistemaType) {
    ...
    async function preencheComboBox() {
        setIsLoading(true)
        console.log('cidadeId: ', getValues('cidadeId'))
    ...
    return (
        ...
        <div className="px-10">
            ...
            <PageSubTitle texto="Clientes do Sistema" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col">
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Valor Mensal</label>
                                    <InputNumber
                                        id={field.name}
                                        inputRef={field.ref}
                                        value={field.value}
                    ...
                    <div className="flex flex-col">
                        <Controller
                            name="dataPrimeiraMensalidade"
                            control={control}
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Data Primeira Mensalidade</label>
                                    <Calendar
                                        inputId={field.name}
                                        value={field.value}
                    ...
                    <div className="flex flex-col">
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Dia Cobrança</label>
                                    <InputNumber
                                        id={field.name}
                                        inputRef={field.ref}
                                        value={field.value}
                    ...
                    <div className="flex flex-col">
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Data Fim Licença</label>
                                    <Calendar
                                        inputId={field.name}
                                        value={field.value}
                                        onChange={field.onChange}
                    ...
                    {/* <div className="flex flex-col">
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Status Loja</label>
                                    <Dropdown
                                        id={field.name}
                                        value={field.value}
                                        optionLabel="nome"
                                        optionValue="codigo"
                                        options={codigoNomeStatusLoja}
                    ...
                    {/* <div className="flex flex-col">
                        <Controller
                            name="senha_sincronizador"
                            defaultValue=""
                            control={control}
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Senha Sincronizador</label>
                                    <InputText
                                        id={field.name}
                                        value={field.value}
                                        className={classNames({ 'p-invalid': fieldState.error })}
                    ...
                    {/* <div className="flex flex-col">
                        <Controller
                            name="terminal_sincronizador"
                            defaultValue=""
                            control={control}
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Terminal Sincronizador</label>
                                    <InputText
                                        id={field.name}
                                        value={field.value}
                                        className={classNames({ 'p-invalid': fieldState.error })}
                    ...
                    {/* <div className="flex flex-col">
                        <Controller
                            name="modulo_delivery"
                            control={control}
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Delivery</label>
                                    <Dropdown
                                        id={field.name}
                                        value={field.value}
                                        optionLabel="nome"
                    ...
                    {/* <div className="flex flex-col">
                        <Controller
                            name="modulo_mesas_comandas"
                            control={control}
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Mesas/Comandas</label>
                                    <Dropdown
                                        id={field.name}
                                        value={field.value}
                                        optionLabel="nome"
                    ...
                    {/* <div className="flex flex-col">
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Balcão</label>
                                    <Dropdown
                                        id={field.name}
                                        value={field.value}
                                        optionLabel="nome"
                    ...
                    {/* <div className="flex flex-col">
                        <Controller
                            ...
                            render={({ field, fieldState }) => (
                                <>
                                    <label htmlFor={field.name}>Fiscal</label>
                                    <Dropdown
                                        id={field.name}
                                        value={field.value}
                                        optionLabel="nome"
