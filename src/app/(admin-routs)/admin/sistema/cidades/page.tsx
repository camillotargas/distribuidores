...
import { getAll } from '@/actions/sistema/cidades'
...
export default function Grid() {
    ...
    const botoesDataTable = (dados: cidadesType) => {
        return (
            <>
    ...
    // const formataStatus = (dados: cidadesType) => {
    //     return (
    //         <>
    ...
    return (
        ...
        <div className='mx-3'>
            ...
            <PageSubTitle texto="Cadastro de Cidades" />
            ...
            <div className="mt-2">
                ...
                <div className="md:hidden">
                    <DataTable value={dados} size="small" stripedRows showGridlines selectionMode="single" >
                        ...
                        <Column field="estadoNome" header="Estado" sortable></Column>
                ...
                <div className="hidden md:block" >
                    <DataTable value={dados} size="small" stripedRows showGridlines selectionMode="single" >
                        ...
                        <Column field="nome" header="Nome" sortable></Column>
                        <Column field="estadoNome" header="Estado" sortable></Column>
                        <Column field="estadoSigla" header="Sigla" sortable></Column>
                        {/* <Column body={formataStatus} header="Status" sortable></Column> */}
                        <Column body={botoesDataTable} exportable={false}></Column>
                    </DataTable>
                </div>
